...
if ((T->lchild ==NULL)||(T->rchild ==NULL)) return (T->lchild == NULL)?JudgeBiTree(T->rchild):JudgeBiTree(T->lchild);

return (T->lchild->data.key<T->rchild->data.key)?(JudgeBiTree(T->lchild)&JudgeBiTree(T->rchild)):0;

 
/********** End **********/
}
//1 4 a    2 2 b   3  6 c   4  1 d   5  3 e   6  5 f     7  7 g   0  0 null 
//预期输出YES